...
internal sealed class CreateTransactionResponse
{
    ...
    public IEnumerable<TransactionLine> Lines { get; set; }

    [DataMember(Name = "addresses")]
    public IEnumerable<TransactionAddress> Addresses { get; set; }

    [DataMember(Name = "parameters")]
    public IEnumerable<TransactionParameter> Parameters { get; set; }
